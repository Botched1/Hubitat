...
def parse(String description) {
    ...
    if (description != "updated") {
		...
		def cmd = zwave.parse(description, [0x20: 1, 0x25: 1, 0x26: 3, 0x70: 2, 0x72: 2, 0x85: 2, 0x71: 3, 0x56: 1])
		if (cmd) {
...
def switchModeOff(){
	if (logEnable) log.debug "Disabling Switch Mode (Entering Dimmer Mode)"
	def cmds = []
...
def showVersion() { sendEvent (name: "about", value:"Version 1.2.0 (01/24/2019)") }
