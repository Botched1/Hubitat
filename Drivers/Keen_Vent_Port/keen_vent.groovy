    ...
    if (shouldProcessMessage(cluster)) {
        ...
        switch(cluster.clusterId) {
            ...
            case 0x0402:
                ...
                def valueHex = reverseHexString(cluster.data[-2..-1])
        
                def value = convertTemperatureHex(valueHex)
...
private Map parseReportAttributeMessage(String description) {
    ...
    if (descMap.cluster == "0006" && descMap.attrId == "0000") {
        ...
        def valueHex = reverseHexString(descMap.value)
        //log.debug "temp temperature: $valueHex"
        //def newtempvalue = convertTemperatureHex(valueHex)
...
private Map makeBatteryResult(rawValue) {
    ...
    [
        ...
        value: rawValue,
        unit: "%",
        descriptionText: "${linkText} battery is ${rawValue}%",
        isStateChange: true
    ]
}
